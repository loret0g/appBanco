 ...
 *  
 */
public class Gasto extends Dinero {		// Hereda de dinero sus atributos y podemos acceder a sus métodos.
	...
	public String toString() {			
		return "Gasto: " + Main.cambiarPunto(getDinero()) + "€. Descripción: " + getDescription();
